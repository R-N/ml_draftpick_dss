...
class DraftingGame(_Game):
    ...
    def getValidMoves(self, board, player):
        ...
        print(len(legal_moves), type(legal_moves), type(legal_moves[0]), type(legal_moves[0][0]), [sum(x) for x in legal_moves])
        print(len(board.double_possible_moves), type(board.double_possible_moves), type(board.double_possible_moves[0]), type(board.double_possible_moves[0][0]), [sum(x) for x in board.double_possible_moves])
